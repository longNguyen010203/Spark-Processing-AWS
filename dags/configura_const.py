...
BOOK_REVIEW_NAME = "Books_rating.csv"
BOOK_DETAIL_NAME = "books_data.csv"
BOOK_REVIEW_SOURCE = f"s3://{S3_BUCKET_NAME}/{S3_FOLDER_ROOT}/{S3_FOLDER_DATA}/raw/{BOOK_REVIEW_NAME}"
BOOK_DETAIL_SOURCE = f"s3://{S3_BUCKET_NAME}/{S3_FOLDER_ROOT}/{S3_FOLDER_DATA}/raw/{BOOK_DETAIL_NAME}"
BOOK_REVIEW_OUTPUT = f"s3://{S3_BUCKET_NAME}/{S3_FOLDER_ROOT}/{S3_FOLDER_DATA}/transform/{BOOK_REVIEW_NAME}"
BOOK_DETAIL_OUTPUT = f"s3://{S3_BUCKET_NAME}/{S3_FOLDER_ROOT}/{S3_FOLDER_DATA}/transform/{BOOK_DETAIL_NAME}"
